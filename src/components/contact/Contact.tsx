...
const Contact = () => {
  ...
  return (
    <div >
      <div className="max-w-6xl grid grid-cols-1 lg:grid-cols-2 "  >
        <div className="space-y-8 alt" >
        ...
        <div  >
          <h2 className="text-2xl font-semibold text-white "style={{paddingLeft:"10rem"}}>CONTACT FORM</h2>
